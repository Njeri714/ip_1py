...
class Creditials:
    '''
    Creditials class will perform 
    function to do with authentication with
    the aid of data from the user class
    '''
    def __init__(self):
        '''
        constructor function used for testing 
    ...
    def login(cls, username: str, password):
        '''
        Login function will be used to 
        find the user. 
        use the saved credials and allow 
        the user to login the appliaction
        '''
    ...
    def password_generate(self, name):
        ...
        method: 
            will compare. if the username matches the one
             in the list then the function will display the
              users password.    
        '''
        for user in User.disply_user_accounts():
    ...
    def generate_all_saved_accounts(cls):
        '''
        generate all saved account function 
        will be generating the credetials of the user.
