class User:
    ...
    def generate_menu(cls):
        '''
        generate menu function is responsible for displaying
        menu to the user for any function the user is interested in.
        '''
    ...
    def generate_menu_after_login(cls):
        '''
        generate menu after login will be responsible 
        for displaying menu to the user after logging in.
        '''
